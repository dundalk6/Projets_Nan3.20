...
<body>
   <div id="monMenu" class="navbar-wrapper">
    ...
    <div class="whyus">
        <div class="container">
            <div class="row">
              <h2 class="text-right animated  wobble ">Bassin</h2>
              ...
              <hr>
                ...
                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12" >
                    <img style="width:455px; height:300px; border-radius:15px; box-shadow:2px 2px 8px black" src="2020/11.JPG">
                </div>  
    ...
    <div class="whyus">
        <div class="container">
            <div class="row">
              <h2 class="text-right  wobble ">Relaxation</h2>
              
              <hr>
              
                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12" >
                    <img style="width:455px; height:300px; border-radius:15px; box-shadow:2px 2px 8px black" src="2020/21.JPG">
                </div> 
                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
    ...
    <div class="whyus">
        <div class="container">
            <div class="row">
              <h2 class="text-right animated  wobble ">Spa</h2>
              ...
              <hr>
                ...
                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12" >
                    <img style="width:455px; height:300px; border-radius:15px; box-shadow:2px 2px 8px black" src="2020/14.JPG">
                </div>  
    ...
    <div class="whyus" style="margin-bottom:100px">
        <div class="container">
            <div class="row">
              <h2 class="text-right  wobble ">Séance Massage</h2>
              
              <hr>
              
                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12" >
                    <img style="width:455px; height:300px; border-radius:15px; box-shadow:2px 2px 8px black" src="2020/17.JPG">
                </div> 
                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
