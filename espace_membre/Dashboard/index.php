...
<head>
    ...
    <!-- php5 Shim and Respond.js IE9 support of php5 elements and media queries -->
  ...
  <body>
	  <div class="fixed-button">
		<a href="https://codedthemes.com/item/gradient-able-admin-template" target="_blank" class="btn btn-md btn-primary">
			<i class="fa fa-phone" aria-hidden="true"></i> Contactez l'administrateur
		</a>
	  </div>
       <!-- Pre-loader start -->
            ...
            <nav class="navbar header-navbar pcoded-header">
               <div class="navbar-wrapper">
                   <div class="navbar-logo">
                       ...
                       <a href="index.php">
                           <img class="img-fluid" src="assets/images/logo1.png" alt="Ecam-Logo" />
                       </a>
                                   ...
                                   <li>
                                       <div class="media">
                                           ...
                                           <div class="media-body">
                                               <h5 class="notification-user">Dundalki</h5>
                ...
                <div class="pcoded-wrapper">
                    <nav class="pcoded-navbar">
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="pcoded-hasmenu">
                                    <a href="javascript:void(0)">
                                        ...
                                        <span class="pcoded-mtext"  data-i18n="nav.basic-components.main">Collecteurs</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                    <ul class="pcoded-submenu">
                                        <li class=" ">
                                            <a href="accordion.php">
                                                ...
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Nouveau Collecteur</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" ">
                                            <a href="breadcrumb.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs">Liste des Collecteurs</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                ...
                                <li class="pcoded-hasmenu">
                                    <a href="javascript:void(0)">
                                        <span class="pcoded-micon"><i class="ti-layout-grid2-alt"></i></span>
                                        <span class="pcoded-mtext"  data-i18n="nav.basic-components.main">Comptes</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                    <ul class="pcoded-submenu">
                                        <li class=" ">
                                            <a href="accordion.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Nouveau Compte</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" ">
                                            <a href="breadcrumb.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs">Liste des Comptes</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                            ...
                            <div class="pcoded-navigatio-lavel" data-i18n="nav.category.forms">Décaissement</div>
                            <ul class="pcoded-item pcoded-left-item">
                                <li>
                                    <a href="form-elements-component.php">
                                        <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                        <span class="pcoded-mtext" data-i18n="nav.form-components.main">Dotation</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                                <li>
                                    <a href="bs-basic-table.php">
                                        <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                        <span class="pcoded-mtext" data-i18n="nav.form-components.main">Fonctionnement</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                            ...
                            <div class="pcoded-navigatio-lavel" data-i18n="nav.category.forms">Lot</div>
                            <ul class="pcoded-item pcoded-left-item">
                                <li>
                                    <a href="chart.php">
                                        <span class="pcoded-micon"><i class="ti-layers"></i><b>L</b></span>
                                        <span class="pcoded-mtext" data-i18n="nav.form-components.main">Enregistrer un Lot</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                                <li>
                                    <a href="map-google.php">
                                        <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                        <span class="pcoded-mtext" data-i18n="nav.form-components.main">Liste des Lots</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                            ...
                            <div class="pcoded-navigatio-lavel" data-i18n="nav.category.forms">Stock</div>
                            <ul class="pcoded-item pcoded-left-item">
                                <li>
                                    <a href="chart.php">
                                        <span class="pcoded-micon"><i class="ti-layers"></i><b>L</b></span>
                                        <span class="pcoded-mtext" data-i18n="nav.form-components.main">Stock par Collecteur</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                                <li>
                                    <a href="map-google.php">
                                        <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                        <span class="pcoded-mtext" data-i18n="nav.form-components.main">Liste de Stock</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                            ...
                            <div class="pcoded-navigatio-lavel" data-i18n="nav.category.forms">Paramètres</div>
                            <ul class="pcoded-item pcoded-left-item">
                                <li>
                                    <a href="chart.php">
                                        <span class="pcoded-micon"><i class="ti-layers"></i><b>MP</b></span>
                                        <span class="pcoded-mtext" data-i18n="nav.form-components.main">Mon Profil</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                                <li>
                                    <a href="map-google.php">
                                        <span class="pcoded-micon"><i class="ti-layers"></i><b>SD</b></span>
                                        <span class="pcoded-mtext" data-i18n="nav.form-components.main">Se Déconnecter</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                                ...
                                <li class="pcoded-hasmenu ">
                                            <a href="javascript:void(0)">
                                                ...
                                                <span class="pcoded-mtext" data-i18n="nav.menu-levels.menu-level-22.main">Utilisateur</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                            <ul class="pcoded-submenu">
                                                <li class="">
                                                    <a href="javascript:void(0)">
                                                        <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                        <span class="pcoded-mtext" data-i18n="nav.menu-levels.menu-level-22.menu-level-31">Nouvel Utilisateur</span>
                                                        <span class="pcoded-mcaret"></span>
                                                    </a>
                                                </li>
                                                <li class="">
                                                    <a href="javascript:void(0)">
                                                        <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                        <span class="pcoded-mtext" data-i18n="nav.menu-levels.menu-level-22.menu-level-31">Liste des Utilisateurs</span>
                                                        <span class="pcoded-mcaret"></span>
                                                    </a>
                                                </li>
                                            </ul>
                                      ...
                                      <div class="row">
                                            ...
                                            <div class="col-md-6 col-xl-3">
                                                <div class="card bg-c-blue order-card">
                                                    <div class="card-block">
                                                        <h6 class="m-b-20">Total Dotations</h6>
                                                        <h2 class="text-right"><i class="ti-shopping-cart f-left"></i><span>486</span></h2>
                                                        <p class="m-b-0">Dotations Complètes<span class="f-right">351</span></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-xl-3">
                                                <div class="card bg-c-green order-card">
                                                    <div class="card-block">
                                                        <h6 class="m-b-20">Total Utilisateurs</h6>
                                                        <h2 class="text-right"><i class="ti-tag f-left"></i><span>1641</span></h2>
                                                        <p class="m-b-0">Les Utilisateurs</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-xl-3">
                                            ...
                                            <div class="col-md-6 col-xl-3">
                                                <div class="card bg-c-pink order-card">
                                                    <div class="card-block">
                                                        <h6 class="m-b-20">Total Collecteurs</h6>
                                                        <h2 class="text-right"><i class="ti-wallet f-left"></i><span>$9,562</span></h2>
                                                        <p class="m-b-0">Les collecteurs<span class="f-right">$542</span></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- order-card end -->
                                                ...
                                                <div class="card user-card">
                                                  ...
                                                  ?>
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <p class="text-muted">Active | <?= $userinfo['mail'];?></p>
                                                        <hr/>
                                                        <?php
                                                    }
                                                    ?>
