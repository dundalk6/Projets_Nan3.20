    ...
    <div class="page-wrapper">
        ...
        <div class="page-header card">
            <div class="card-block">
                ...
                <p class="text-muted m-b-10">Espace d'enregistrement de Reservations</p>
                <ul class="breadcrumb-title b-t-default p-t-10">
                    ...
                    <li class="breadcrumb-item"><a href="#!">Reservations</a>
                            ...
                            <li class="breadcrumb-item "><button class="btn btn-primary" onclick="window.location.href='liste-reservation.php?id=<?php echo $_SESSION['id']?>'" type=" submit">Liste des Reservations</button>
                            </li>
                </ul>
            </div>
        </div>
