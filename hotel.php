...
<body>
   <div class="navbar-wrapper">
    ...
    margin: 0;" class="fond">
    <div class="container">
      <h2 class="text-center" style="padding-top: 200px;margin: 0; font-size: 90px; color: #fff">Hotel-Chambre</h2>
    </div>
    ...
    <div class="about">
        <div class="container">
            <div class="row">
              <h2 class="text-justify animated  wobble ">Hotel-Chambres</h2>
    ...
    <div class="about">
        <div class="container">
            <div class="row">
              <h2 class="text-right animated  wobble ">Doubles-Chambres</h2>
    ...
    <div class="about">
        <div class="container">
            <div class="row">
              <h2 class="text-left animated  wobble ">Suites-Chambres</h2>
              
              <hr>
                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12" >
                    <img src="images/room3.webp">
                </div>
