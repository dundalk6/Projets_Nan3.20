...
require 'includes/script_col.php';
                        ...
                        <div class="card-block">
                            ...
                            <ul class="breadcrumb-title b-t-default p-t-10">
                                ...
                                <li class="breadcrumb-item"><a href="#!">membres</a>
                                        ...
                                        <li class="breadcrumb-item "><button class="btn btn-success" type=" submit" onclick="window.location.href='liste_formation.php?id=<?php echo
                                                            $_SESSION['id']?>';">Liste des membres</button>
                                                        </li>
                            </ul>
                        </div>
                    </div>
