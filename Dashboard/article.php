...
require 'includes/script-article.php';
                        ...
                        <div class="card-block">
                            ...
                            <ul class="breadcrumb-title b-t-default p-t-10">
                                ...
                                <li class="breadcrumb-item"><a href="#!">Articles</a>
                                        ...
                                        <li class="breadcrumb-item "><button class="btn btn-success" type=" submit" onclick="window.location.href='list-article.php?id=<?php echo
                                                            $_SESSION['id']?>';">Liste des Articles</button>
                                                        </li>
                            </ul>
                        </div>
                    </div>
                                        ...
                                        <div class="card-block">
                                            ...
                                            <form action="" method="POST" enctype="multipart/form-data">
                                                <div class="form-group">
                                                    ...
                                                    <label for="inputEmail4">Titre de l'article</label>
                                                    <input name="article_titre" type="text" class="form-control" id="inputEmail4" placeholder="" required="">
                                                    
                                                    
                                                </div>

                                                <div class="form-group">
                                                    <label for="inputAddress">Votre Contenu</label>
                                                    
                                                    <textarea name="article_contenu" type="mail" class="form-control" id="inputAddress" required=""></textarea>
                                                </div>
                                                <div class="form-group">
