...
$colParPage = 5;
$reqColTotal = $bdd->query("SELECT id FROM formation");
								...
								<!-- Page-header start -->
                                    <div class="page-header card">
                                       ...
                                       $_SESSION['id']?>"> <i class="fa fa-home"></i> </a>
                                                        ...
                                                        <li class="breadcrumb-item "><button class="btn btn-success" type="     submit" onclick="window.location.href='formation.php?id=<?php echo
                                                            $_SESSION['id']?>';">Voulez-Vous ajouter un membre?</button>
                                                        </li>
                                            </ul>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-block table-border-style">
                                            <div class="table-responsive">
                                                <table class="table table-hover">
                                                    ...
                                                    <?php
                                                    $liste = $bdd->query('SELECT * FROM formation ORDER BY id LIMIT '.$depart.','.$colParPage);
                                                        while ($l=$liste->fetch()) 
                                                        {
                                                            ...
                                                            <nav aria-label="...">
                                                              <ul class="pagination pagination-sm">
                                                                ...
                                                                <li class="page-item">
                                                                    <span class="page-link">
                                                                    <?php
                                                                    echo '<a href="liste_formation.php?id='.$_SESSION['id'].'&page='.$i.'">'.$i.'</a>';
                                                                            }
                                                                        }
