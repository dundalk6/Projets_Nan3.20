...
$colParPage = 5;
$reqColTotal = $bdd->query("SELECT id FROM articles");
...
if (isset($_GET['publier']) and !empty($_GET['publier'])) 
{
    ...
    $req = $bdd->prepare("UPDATE articles set confirme = 1 where id=?");
								...
								<!-- Page-header start -->
                                    <div class="page-header card">
                                       ...
                                       $_SESSION['id']?>"> <i class="fa fa-home"></i> </a>
                                                        ...
                                                        <li class="breadcrumb-item "><button class="btn btn-success" type="     submit" onclick="window.location.href='article.php?id=<?php echo
                                                            $_SESSION['id']?>'">Voulez-Vous ajouter un Article?</button>
                                                        </li>
                                            </ul>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-block table-border-style">
                                            <div class="table-responsive">
                                                <table class="table table-hover">
                                                    ...
                                                    <?php
                                                    $liste = $bdd->query('SELECT * FROM articles ORDER BY date_time_publication desc LIMIT '.$depart.','.$colParPage);
                                                        while ($l=$liste->fetch()) 
                                                        {
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td><img src="miniatures/<?=$l['id'] ?>.jpg" width="150" height="100"></td>
                                                            ...
                                                            $_SESSION['id']?>&publier=<?=$l['id'] ?>" style="color: #fff" title="Publier" class="btn btn-out-dotted btn-success btn-square" onclick="window.alert('Votre article a bien été publié!!')"><span class="ti-export"></span></a>
                                                                <?php } ?>
                                                            ...
                                                            <nav aria-label="...">
                                                              <ul class="pagination pagination-sm">
                                                                ...
                                                                <li class="page-item">
                                                                    <span class="page-link">
                                                                    <?php
                                                                    echo '<a href="list-article?id='.$_SESSION['id'].'&page='.$i.'">'.$i.'</a>';
                                                                            }
                                                                        }
