...
<div class="monRestau">
    <div id="exTab2" class="container">	
        <ul class="nav nav-tabs">
			<li class="active">
                <a  href="#1" data-toggle="tab">Pétit-Déjeuner</a>
			</li>
			<li><a href="#2" data-toggle="tab">Déjeuner</a>
			</li>
			<li><a href="#3" data-toggle="tab">Diner</a>
            </li>
            <li><a href="#4" id="boisson" data-toggle="tab">Boissons & Sucreries</a>
			</li>
		</ul>
        ...
        <div class="tab-content ">
            ...
            <div class="tab-pane active" id="1">
                <div class="petit-dejeuner">
                    <div class="container">
                        <div class="row mb-30">
                            <div class="col-lg-4 col-sm-6">
                                <div class="monRestau_item text-center">
                                    <div class="monRestau_img">
                                        <img style="width:100%" src="2020/6.jpg" alt="">
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="monRestau_item text-center">
                                    <div class="monRestau_img">
                                        <img style="width:100%" src="2020/1.jpg" alt="">
                                        
                                    </div>
                                    <!-- <a href="#"><h4 class="">Petit Déjeuner 2</h4></a>
                                    <h5>Yediminh<small>/Restau</small></h5> -->
                                </div>
                            </div>
                            <div class="col-lg-4 col-sm-6">
                                <div class="monRestau_item text-center">
                                    <div class="monRestau_img">
                                        <img style="width:100%" src="2020/8.jpg" alt="">
                                        
                                    </div>
                                    <!-- <a href="#"><h4 class="">Petit Déjeuner 3</h4></a>
                                    <h5>Yediminh<small>/Restau</small></h5> -->
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="container">
                            <div class="row mb-30">
                                <div class="col-lg-4 col-sm-6">
                                    <div class="monRestau_item text-center">
                                        <div class="monRestau_img">
                                            <img style="width:100%" src="2020/7.jpg" alt="">
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    <div class="monRestau_item text-center">
                                        <div class="monRestau_img">
                                            <img style="width:100%" src="2020/9.jpg" alt="">
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    <div class="monRestau_item text-center">
                                        <div class="monRestau_img">
                                            <img style="width:100%" src="2020/15.jpg" alt="">
                    ...
                    <div class="container">
                        <div class="row mb-30">
                            <div class="col-lg-4 col-sm-6">
                                <div class="monRestau_item text-center">
                                    <div class="monRestau_img">
                                        <img style="width:100%" src="2020/29.PNG" alt="">
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="monRestau_item text-center">
                                    <div class="monRestau_img">
                                        <img style="width:100%" src="2020/16.jpg" alt="">
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="monRestau_item text-center">
                                    <div class="monRestau_img">
                                        <img style="width:100%" src="2020/35.PNG" alt="">
                    ...
                    <div class="container">
                        <div  class="row mb-30">
                            <div class="col-lg-4 col-sm-6">
                                <div class="monRestau_item text-center">
                                    <div class="monRestau_img">
                                        <img style="width:100%" src="2020/36.PNG" alt="">
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="monRestau_item text-center">
                                    <div class="monRestau_img">
                                        <img style="width:100%" src="2020/37.JPG" alt="">
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="monRestau_item text-center">
                                    <div class="monRestau_img">
                                        <img style="width:100%" src="2020/28.PNG" alt="">
